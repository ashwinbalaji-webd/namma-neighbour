...
Generate content for section `section-06-seller-onboarding` (filename: `section-06-seller-onboarding.md`).
...
for `section-06-seller-onboarding` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-06-seller-onboarding.md`
