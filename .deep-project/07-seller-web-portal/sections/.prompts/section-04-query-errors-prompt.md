...
Generate content for section `section-04-query-errors` (filename: `section-04-query-errors.md`).
...
for `section-04-query-errors` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-04-query-errors.md`
