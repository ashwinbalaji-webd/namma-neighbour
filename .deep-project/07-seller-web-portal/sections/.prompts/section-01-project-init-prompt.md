...
Generate content for section `section-01-project-init` (filename: `section-01-project-init.md`).
...
for `section-01-project-init` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-01-project-init.md`
