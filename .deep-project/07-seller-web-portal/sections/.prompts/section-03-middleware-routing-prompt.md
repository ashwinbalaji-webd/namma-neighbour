...
Generate content for section `section-03-middleware-routing` (filename: `section-03-middleware-routing.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/claude-plan.md` - Full implementation plan
2. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/claude-plan-tdd.md` - Test stubs for each section
3. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-middleware-routing` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-03-middleware-routing.md`
