...
Generate content for section `section-05-seller-layout` (filename: `section-05-seller-layout.md`).
...
for `section-05-seller-layout` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-05-seller-layout.md`
