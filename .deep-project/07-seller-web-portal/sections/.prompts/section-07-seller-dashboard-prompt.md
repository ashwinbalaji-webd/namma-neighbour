...
Generate content for section `section-07-seller-dashboard` (filename: `section-07-seller-dashboard.md`).
...
for `section-07-seller-dashboard` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-07-seller-dashboard.md`
