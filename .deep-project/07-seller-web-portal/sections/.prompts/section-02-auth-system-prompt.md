...
Generate content for section `section-02-auth-system` (filename: `section-02-auth-system.md`).
...
for `section-02-auth-system` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-02-auth-system.md`
