...
Generate content for section `section-08-seller-listings` (filename: `section-08-seller-listings.md`).
...
for `section-08-seller-listings` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/07-seller-web-portal/sections/section-08-seller-listings.md`
