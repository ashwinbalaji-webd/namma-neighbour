...
Generate content for section `section-02-core-app` (filename: `section-02-core-app.md`).
...
for `section-02-core-app` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/01-foundation/sections/section-02-core-app.md`
