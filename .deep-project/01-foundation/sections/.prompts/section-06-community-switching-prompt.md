...
Generate content for section `section-06-community-switching` (filename: `section-06-community-switching.md`).
...
for `section-06-community-switching` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/01-foundation/sections/section-06-community-switching.md`
