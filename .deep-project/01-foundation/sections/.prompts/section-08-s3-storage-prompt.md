...
Generate content for section `section-08-s3-storage` (filename: `section-08-s3-storage.md`).
...
for `section-08-s3-storage` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/01-foundation/sections/section-08-s3-storage.md`
