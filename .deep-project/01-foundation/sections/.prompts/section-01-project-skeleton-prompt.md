...
Generate content for section `section-01-project-skeleton` (filename: `section-01-project-skeleton.md`).
...
for `section-01-project-skeleton` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/01-foundation/sections/section-01-project-skeleton.md`
