...
Generate content for section `section-04-otp-send` (filename: `section-04-otp-send.md`).
...
for `section-04-otp-send` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/01-foundation/sections/section-04-otp-send.md`
