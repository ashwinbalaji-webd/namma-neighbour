...
Generate content for section `section-12-native-config` (filename: `section-12-native-config.md`).
...
for `section-12-native-config` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-12-native-config.md`
