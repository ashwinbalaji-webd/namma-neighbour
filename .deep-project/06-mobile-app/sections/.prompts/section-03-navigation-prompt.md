...
Generate content for section `section-03-navigation` (filename: `section-03-navigation.md`).
...
for `section-03-navigation` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-03-navigation.md`
