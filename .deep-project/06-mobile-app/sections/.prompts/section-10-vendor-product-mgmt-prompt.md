...
Generate content for section `section-10-vendor-product-mgmt` (filename: `section-10-vendor-product-mgmt.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/claude-plan.md` - Full implementation plan
2. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/claude-plan-tdd.md` - Test stubs for each section
3. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-10-vendor-product-mgmt` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-10-vendor-product-mgmt.md`
