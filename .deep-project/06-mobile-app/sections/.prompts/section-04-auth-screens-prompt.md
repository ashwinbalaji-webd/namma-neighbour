...
Generate content for section `section-04-auth-screens` (filename: `section-04-auth-screens.md`).
...
for `section-04-auth-screens` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-04-auth-screens.md`
