...
Generate content for section `section-06-resident-catalog` (filename: `section-06-resident-catalog.md`).
...
for `section-06-resident-catalog` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-06-resident-catalog.md`
