...
Generate content for section `section-07-payment-flow` (filename: `section-07-payment-flow.md`).
...
for `section-07-payment-flow` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-07-payment-flow.md`
