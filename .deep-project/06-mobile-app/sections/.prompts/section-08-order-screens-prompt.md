...
Generate content for section `section-08-order-screens` (filename: `section-08-order-screens.md`).
...
for `section-08-order-screens` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-08-order-screens.md`
