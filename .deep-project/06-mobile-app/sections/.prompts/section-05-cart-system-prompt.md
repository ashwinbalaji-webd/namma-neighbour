...
Generate content for section `section-05-cart-system` (filename: `section-05-cart-system.md`).
...
for `section-05-cart-system` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/06-mobile-app/sections/section-05-cart-system.md`
