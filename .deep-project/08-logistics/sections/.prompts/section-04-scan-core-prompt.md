...
Generate content for section `section-04-scan-core` (filename: `section-04-scan-core.md`).
...
for `section-04-scan-core` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/sections/section-04-scan-core.md`
