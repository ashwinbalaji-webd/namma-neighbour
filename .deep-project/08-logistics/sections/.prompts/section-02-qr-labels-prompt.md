...
Generate content for section `section-02-qr-labels` (filename: `section-02-qr-labels.md`).
...
for `section-02-qr-labels` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/sections/section-02-qr-labels.md`
