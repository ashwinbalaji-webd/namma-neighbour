...
Generate content for section `section-05-notifications` (filename: `section-05-notifications.md`).
...
for `section-05-notifications` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/sections/section-05-notifications.md`
