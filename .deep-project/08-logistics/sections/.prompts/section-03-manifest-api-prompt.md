...
Generate content for section `section-03-manifest-api` (filename: `section-03-manifest-api.md`).
...
for `section-03-manifest-api` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/sections/section-03-manifest-api.md`
