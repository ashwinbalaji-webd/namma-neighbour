...
Generate content for section `section-07-mobile-screens` (filename: `section-07-mobile-screens.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/claude-plan.md` - Full implementation plan
2. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/claude-plan-tdd.md` - Test stubs for each section
3. `/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-mobile-screens` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/08-logistics/sections/section-07-mobile-screens.md`
