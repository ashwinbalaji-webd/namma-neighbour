...
Generate content for section `section-04-celery-tasks` (filename: `section-04-celery-tasks.md`).
...
for `section-04-celery-tasks` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/09-fintech-unified-billing/sections/section-04-celery-tasks.md`
