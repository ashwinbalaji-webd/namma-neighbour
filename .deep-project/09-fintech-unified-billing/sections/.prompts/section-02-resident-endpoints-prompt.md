...
Generate content for section `section-02-resident-endpoints` (filename: `section-02-resident-endpoints.md`).
...
for `section-02-resident-endpoints` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/09-fintech-unified-billing/sections/section-02-resident-endpoints.md`
