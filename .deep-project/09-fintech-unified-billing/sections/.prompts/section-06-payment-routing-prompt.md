...
Generate content for section `section-06-payment-routing` (filename: `section-06-payment-routing.md`).
...
for `section-06-payment-routing` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/09-fintech-unified-billing/sections/section-06-payment-routing.md`
