...
Generate content for section `section-03-admin-endpoints` (filename: `section-03-admin-endpoints.md`).
...
for `section-03-admin-endpoints` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/09-fintech-unified-billing/sections/section-03-admin-endpoints.md`
