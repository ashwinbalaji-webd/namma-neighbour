...
Generate content for section `section-03-community-views` (filename: `section-03-community-views.md`).
...
for `section-03-community-views` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/02-community-onboarding/sections/section-03-community-views.md`
