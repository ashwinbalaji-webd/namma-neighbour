...
Generate content for section `section-07-django-admin` (filename: `section-07-django-admin.md`).
...
for `section-07-django-admin` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/02-community-onboarding/sections/section-07-django-admin.md`
