...
Generate content for section `section-05-admin-views` (filename: `section-05-admin-views.md`).
...
for `section-05-admin-views` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/02-community-onboarding/sections/section-05-admin-views.md`
