...
Generate content for section `section-02-serializers` (filename: `section-02-serializers.md`).
...
for `section-02-serializers` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/02-community-onboarding/sections/section-02-serializers.md`
