...
Generate content for section `section-08-tests` (filename: `section-08-tests.md`).
...
for `section-08-tests` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/02-community-onboarding/sections/section-08-tests.md`
