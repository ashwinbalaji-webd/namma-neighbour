...
Generate content for section `section-03-celery-tasks` (filename: `section-03-celery-tasks.md`).
...
for `section-03-celery-tasks` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/04-marketplace-catalog/sections/section-03-celery-tasks.md`
