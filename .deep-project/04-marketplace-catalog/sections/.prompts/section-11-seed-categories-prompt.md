...
Generate content for section `section-11-seed-categories` (filename: `section-11-seed-categories.md`).
...
for `section-11-seed-categories` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/04-marketplace-catalog/sections/section-11-seed-categories.md`
