...
Generate content for section `section-06-product-detail` (filename: `section-06-product-detail.md`).
...
for `section-06-product-detail` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/04-marketplace-catalog/sections/section-06-product-detail.md`
