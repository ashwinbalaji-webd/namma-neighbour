...
Generate content for section `section-08-image-upload` (filename: `section-08-image-upload.md`).
...
for `section-08-image-upload` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/04-marketplace-catalog/sections/section-08-image-upload.md`
