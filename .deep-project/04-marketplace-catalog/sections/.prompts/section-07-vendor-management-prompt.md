...
Generate content for section `section-07-vendor-management` (filename: `section-07-vendor-management.md`).
...
for `section-07-vendor-management` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/04-marketplace-catalog/sections/section-07-vendor-management.md`
