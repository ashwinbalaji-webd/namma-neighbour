...
Generate content for section `section-02-permissions-exceptions` (filename: `section-02-permissions-exceptions.md`).
...
for `section-02-permissions-exceptions` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-02-permissions-exceptions.md`
