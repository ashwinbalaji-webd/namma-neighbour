...
Generate content for section `section-05-s3-document-upload` (filename: `section-05-s3-document-upload.md`).
...
for `section-05-s3-document-upload` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-05-s3-document-upload.md`
