...
Generate content for section `section-11-django-admin` (filename: `section-11-django-admin.md`).
...
for `section-11-django-admin` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-11-django-admin.md`
