...
Generate content for section `section-04-razorpay-service` (filename: `section-04-razorpay-service.md`).
...
for `section-04-razorpay-service` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-04-razorpay-service.md`
