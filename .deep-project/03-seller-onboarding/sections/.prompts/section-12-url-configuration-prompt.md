...
Generate content for section `section-12-url-configuration` (filename: `section-12-url-configuration.md`).
...
for `section-12-url-configuration` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-12-url-configuration.md`
