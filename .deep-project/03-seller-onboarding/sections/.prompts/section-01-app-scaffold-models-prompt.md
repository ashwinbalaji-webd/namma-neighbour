...
Generate content for section `section-01-app-scaffold-models` (filename: `section-01-app-scaffold-models.md`).
...
for `section-01-app-scaffold-models` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-01-app-scaffold-models.md`
