...
Generate content for section `section-09-celery-tasks` (filename: `section-09-celery-tasks.md`).
...
for `section-09-celery-tasks` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/03-seller-onboarding/sections/section-09-celery-tasks.md`
