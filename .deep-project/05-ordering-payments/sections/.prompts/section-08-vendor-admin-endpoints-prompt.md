...
Generate content for section `section-08-vendor-admin-endpoints` (filename: `section-08-vendor-admin-endpoints.md`).
...
for `section-08-vendor-admin-endpoints` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/05-ordering-payments/sections/section-08-vendor-admin-endpoints.md`
