...
Generate content for section `section-05-celery-tasks` (filename: `section-05-celery-tasks.md`).
...
for `section-05-celery-tasks` to understand what this section should contain.
...
`/var/www/html/MadGirlfriend/namma-neighbour/.deep-project/05-ordering-payments/sections/section-05-celery-tasks.md`
